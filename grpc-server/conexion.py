...
class PedidoServiceServicer(pedido_pb2_grpc.PedidoServiceServicer):
    ...
    def CrearPedido(self, request, context):
        ...
        return pedido_pb2.PedidoResponse(estado="Pedido recibido y enviado a Kafka")
...
def serve():
    ...
    pedido_pb2_grpc.add_PedidoServiceServicer_to_server(PedidoServiceServicer(producer), server)
